...
public class Q5 {
	...
	public static void main(String[] args) throws IOException {
		...
		System.out.println("Enter the name of the File you want to Encrypt(includign the .dat extension):");
		String input = sc.nextLine();
		//String input = "score.dat";
		System.out.println("What should be the name of the new Encrypted File:");
		...
		if (fileIn.exists()) {
			...
			System.out.println("File does not exist therefore cannot be encrypted");
			System.exit(1);
		}
		try (
